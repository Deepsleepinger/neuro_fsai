...
class Net(nn.Module):
    def __init__(self, 
        ...
        if args.use_global:        
            ...
            edge_decoder_dim += hidden_dim_processor_edge 
        self.edge_decoder_L = MLP(edge_decoder_dim, 1, hidden_dim_decoder, hidden_layers_decoder, norm_type=None) # must be None
        self.edge_decoder_D = MLP(edge_decoder_dim, 1, hidden_dim_decoder, hidden_layers_decoder, norm_type=None) # must be None
